              ...
              _ = function (e) {
                ...
                !(function h(n, e, m, g, t, a) {
                  ...
                  if (0 === m && !1 !== ne.insertClose) {
                    var f = te.createElement("a", { href: "#", class: "nav-close-button" + (ne.labelClose ? " has-label" : ""), role: "menuitem", tabindex: 0, "aria-label": ne.labelClose ? "" : (ne.ariaLabels || {}).close }, [
                      ne.labelClose || "",
          ...
          n &&
            (function (e, t) {
              for (var n = 0; n < e.length; n++)
                if (e[n]._eventListeners) for (var a in e[n]._eventListeners) for (var r = 0; r < e[n]._eventListeners[a].length; r++) t[r].addEventListener(a, e[n]._eventListeners[a][r].fn, e[n]._eventListeners[a][r].options);
            })(r, i),
          a
        );
      },
